...
class TestAPIOrchestrator:
    ...
    def test_health_endpoint(self):
        ...
        health_data = {"status": "healthy", "services": {"mcsi": "healthy", "yield": "healthy"}}
...
class TestChatEndpoint:
    ...
    def test_chat_response_structure(self):
        ...
        response = {"answer": "NDVI is a vegetation index.", "sources": ["doc1.pdf"], "context_used": True}
...
class TestDataIntegration:
    ...
    def test_mcsi_data_format(self):
        ...
        mcsi_data = {
            ...
            "week_of_season": 15,
            "mcsi_score": 45.2,
            "indicators": {"ndvi_mean": 0.75, "lst_mean": 28.5},
        }
    ...
    def test_yield_data_format(self):
        ...
        yield_data = {"fips": "19001", "week": 15, "predicted_yield": 185.5, "confidence_interval": 0.31}
...
class TestErrorHandling:
    ...
    def test_service_unavailable_handling(self):
        ...
        error_response = {"status": "degraded", "error": "Service unavailable"}
...
class TestRequestValidation:
    ...
    def test_chat_request_validation(self):
        ...
        valid_request = {"query": "What is NDVI?", "include_context": True}

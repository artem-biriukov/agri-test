...
class TestRAGVectorSearch:
    ...
    def test_vector_search_returns_results(self, mock_chromadb):
        ...
        mock_collection.query.return_value = {
            "documents": [
                ["NDVI is a vegetation index...", "NDVI values range from 0 to 1...", "Healthy corn has NDVI > 0.6..."]
            ],
...
class TestRAGService:
    ...
    def test_health_endpoint_structure(self):
        ...
        health_response = {"status": "healthy", "chromadb": "connected"}

        assert "status" in health_response

    def test_query_endpoint_structure(self):
        """Test query endpoint structure"""
        request = {"query": "What is NDVI?", "top_k": 5}
    ...
    def test_chat_endpoint_structure(self):
        ...
        request = {"query": "What is NDVI?", "context": {"fips": "19001", "stress": 45.2}}
